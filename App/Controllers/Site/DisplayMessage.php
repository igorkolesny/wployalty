...
class DisplayMessage extends Base
{
    ...
    function getCartMessage($is_cart = true)
    {
        ...
        $short_code_list = array(
            ...
            '{wlr_cart_points}' => $point > 0 ? number_format_i18n($point) : '',
    ...
    function getCartRedeemMessage($is_cart = true)
    {
        ...
        if (!empty($user_email)) {
            ...
            if (count($reward_list) > 0 || $points > 0) {
                ...
                $short_code_list = array(
                    '{wlr_points}' => $points > 0 ? number_format_i18n($points) : '',
                    '{wlr_redeem_cart_points}' => $points > 0 ? number_format_i18n($points) : '',
