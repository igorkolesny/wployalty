    ...
    function getPluginLabels()
    {
        ...
        $json = array(
            ...
            'common' => array(
                ...
                'video_link' => 'https://wployalty.net/video-tutorials/',
            ...
            'conditions' => array(
                ...
                'customer' => array(
                    'name' => __('Customer', 'wp-loyalty-rules'),
            ...
            'earn_campaign' => array(
                ...
                'signup' => array(
                    ...
                    'message' => array(
                        ...
                        'description' => __('You can show this message at the account registration / creation page or at the account creation section in checkout page. Shortcodes: {wlr_points}, {wlr_points_label}, {wlr_rewards}', 'wp-loyalty-rules'),
                    ),
                    'start_date' => array(
                        'name' => __('Campaign Start date', 'wp-loyalty-rules'),
                    ),
            ...
            'levels' => array(
                ...
                'level_name_label' => __('Level name', 'wp-loyalty-rules'),
            ...
            'settings' => array(
                ...
                'pages' => array(
                    ...
                    'create_page' => array(
                        'name' => __('Create loyalty page', 'wp-loyalty-rules'),
                        'description' => __('Create loyalty page display customer points and rewards', 'wp-loyalty-rules'),
