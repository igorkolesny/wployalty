...
class Premium
{
    ...
    function init()
    {
        ...
        if (is_admin()) {
            ...
            /*License*/
            add_action('wp_ajax_wlr_validate_license', array(self::$pro_admin, 'validateLicense'));
            add_filter('wlr_is_license_valid', array(self::$pro_admin, 'isValidLicense'), 10, 2);
        ...
        add_action('woocommerce_order_status_changed', array(self::$pro_referral, 'updateProPoints'), 1000, 4);
